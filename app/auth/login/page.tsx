        ...
        <div className="flex min-h-screen items-center justify-center p-4">
            <div className="bg-white rounded-lg shadow-md p-6 w-full max-w-md">
                <div className="mb-6">
                    ...
                    <p className="text-center text-gray-600">我们将发送一个Magic Link到您的邮箱</p>
                </div>
                <div>
                ...
                <div className="mt-6">
                    <button
                        ...
                        disabled={loading}
                        className="w-full bg-blue-500 hover:bg-blue-600 text-white p-3 rounded flex items-center justify-center gap-2"
                    >
                        {loading ? (
                            <>
