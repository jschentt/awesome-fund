                        ...
                        <>
                            <div className="flex items-center gap-2 relative group">
                                ...
                                {(() => {
                                    ...
                                    const badge =
                                        planCode === 'year' ? (
                                            <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 cursor-default">
                                                <span className="w-2 h-2 rounded-full bg-yellow-500 mr-1 animate-pulse"></span>
                                                年度会员
                                            </span>
                                        ) : planCode === 'month' ? (
                                            <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800 cursor-default">
                                                <span className="w-2 h-2 rounded-full bg-blue-500 mr-1 animate-pulse"></span>
                                                月度会员
                                            </span>
                                        ) : (
                                            <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 cursor-default">
