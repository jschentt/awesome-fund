                ...
                <div className="flex w-full">
                    <Space.Compact className="w-full">
                        <Button
                            ...
                            className={`flex items-center justify-center space-x-2 px-2 py-1.5 sm:px-4 sm:py-2 flex-1 text-xs sm:text-sm ${activeTab === 'all' ? 'bg-blue-50 border-blue-200 text-blue-700 rounded-md' : ''}`}
                            onClick={() => onTabChange('all')}
                        >
                            <span className="hidden sm:inline font-medium">全部基金</span>
                            <span
                                className={`px-1.5 py-0.5 rounded-full text-[10px] sm:text-xs font-medium ${activeTab === 'all' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-700'}`}
                            >
                                {total}
                            </span>
                        </Button>
                        <Button
                            ...
                            className={`flex items-center justify-center space-x-2 px-2 py-1.5 sm:px-4 sm:py-2 flex-1 text-xs sm:text-sm ${activeTab === 'monitoring' ? 'bg-blue-50 border-blue-200 text-blue-700 rounded-md' : ''}`}
                            onClick={() => onTabChange('monitoring')}
                        >
                            <Eye className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                            <span className="hidden sm:inline font-medium">我的监控</span>
                            <span
                                className={`px-1.5 py-0.5 rounded-full text-[10px] sm:text-xs font-medium ${activeTab === 'monitoring' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-700'}`}
                            >
                                {monitorCount}
                            </span>
                        </Button>
                        <Button
                            ...
                            className={`flex items-center justify-center space-x-2 px-2 py-1.5 sm:px-4 sm:py-2 flex-1 text-xs sm:text-sm ${activeTab === 'favorite' ? 'bg-blue-50 border-blue-200 text-blue-700 rounded-md' : ''}`}
                            onClick={() => onTabChange('favorite')}
                        >
                            <Star className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                            <span className="hidden sm:inline font-medium">我的收藏</span>
                            <span
                                className={`px-1.5 py-0.5 rounded-full text-[10px] sm:text-xs font-medium ${activeTab === 'favorite' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-700'}`}
                            >
                                {favoriteCount}
                            </span>
                        </Button>
